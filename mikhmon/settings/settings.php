...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($id == "settings" && explode("-",$router)[0] == "new") {
    ...
    fwrite($f, "\n'$'data['".$router."'] = array ('1'=>'".$router."!','".$router."@|@','".$router."#|#','".$router."%','".$router."^','".$router."&TZS','".$router."*10','".$router."(1','".$router.")','".$router."=10','".$router."@!@disable');");
    fclose($f);
    $search = "'$'data";
    $replace = (string)"$data";
...
<div class="col-12">
	<div class="card">
        <div class="card-header">
            <h3 class="card-title">Lakimboria Data</h3>
        </div>
    <div class="card-body">    
	<table class="table table-sm">
	<tr>
