...
<div id="navbar" class="navbar">
  <div class="navbar-left">
    <a id="brand" class="text-center" href="javascript:void(0)">Lakimboria WiFi</a>
...
?>  
  ...
  <a  href="./admin.php?id=settings&session=<?= $session; ?>" class="menu <?= $ssettings; ?>" title="Lakimboria Settings"><i class='fa fa-gear'></i> <?= $_session_settings ?></a>
...
<div id="navbar" class="navbar">
  <div class="navbar-left">
    <a id="brand" class="text-center" href="./?session=<?= $session; ?>">Lakimboria WiFi</a>
